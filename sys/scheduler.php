		...
		<div id="sysadmin">
			<h1>SCHEDULER
			<?php if($_GET['ntfy']=='sched'){?>
				<a href="scheduler.php"><button class="btn btn-default">BACK</button></a>
			<?php }?></h1> 
			<h6>Creates a <b>Scheduler</b> account that can be used for scheduling the classes of the institute. </h6>
		</div>	<br>
		<?php if(!isset($_GET['ntfy'])){?>
		<div id="scheduler">
			<div>
				<a href="?ntfy=sched"><button class="btn btn-primary">+</button></a><br>
			</div><br>
			<div class="table-responsive " id="table-scroller">
	            <table class="table table-bordered">
	              ...
	              <tbody>
	              	<?php include 'modules/getdbemailsched.php';?>
	              </tbody>
	            </table>
	         </div>
		</div>
